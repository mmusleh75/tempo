...
DROP PROCEDURE IF EXISTS `sp_intbug_tickets_pc`$$

CREATE PROCEDURE `sp_intbug_tickets_pc`()
BEGIN
	DROP TABLE IF EXISTS temp_intbug_tickets_pc;
	CREATE TABLE temp_intbug_tickets_pc
	SELECT
	...
	DELETE FROM jiraanalysis.temp_intbug_tickets_pc 
