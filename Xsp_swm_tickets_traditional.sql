...
DROP PROCEDURE IF EXISTS `sp_swm_tickets_traditional`$$

CREATE PROCEDURE `sp_swm_tickets_traditional`()
BEGIN
	DROP TABLE IF EXISTS temp_swm_tickets_traditional;
	CREATE TABLE temp_swm_tickets_traditional
	SELECT
