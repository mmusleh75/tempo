...
DROP PROCEDURE IF EXISTS `sp_swm_tickets_pc`$$

CREATE PROCEDURE `sp_swm_tickets_pc`()
BEGIN
	DROP TABLE IF EXISTS temp_swm_tickets_pc;
	CREATE TABLE temp_swm_tickets_pc
	SELECT
	...
	DELETE FROM jiraanalysis.temp_swm_tickets_pc 
