...
DROP TABLE IF EXISTS jiraanalysis._story_points_tmp;
CREATE TABLE jiraanalysis._story_points_tmp
...
DROP TABLE IF EXISTS jiraanalysis._sprints_tmp;
CREATE TABLE jiraanalysis._sprints_tmp
SELECT p.id AS ProjectID
,j.id AS JiraID
,j.issuenum AS IssueKey
...
FROM jiraanalysis._story_points_tmp p
INNER JOIN jiraanalysis._sprints_tmp s
...
SELECT * 
FROM jiraanalysis._story_points_tmp
