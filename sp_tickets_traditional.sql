...
DROP PROCEDURE IF EXISTS `sp_tickets_traditional`$$

CREATE PROCEDURE `sp_tickets_traditional`()
BEGIN
	DROP TABLE IF EXISTS jiraanalysis.temp_traditional;
	CREATE TABLE jiraanalysis.temp_traditional
	SELECT
	...
	WHERE jira.issuetype IN (1,4,10103,10109,10110)
