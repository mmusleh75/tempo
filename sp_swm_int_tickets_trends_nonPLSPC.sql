...
#	select @prev_month,@future_1st_of_month, @future_month;
	...
	WHERE tt.CreateDate >= '2017-02-01'
...
#	and ResolvedDate is not null
	...
	IF (SELECT COUNT(1) FROM temp_swm_int_monthly_trends_nonPLSPC 
	...
	INSERT INTO swm_int_monthly_trends_nonPLSPC_archive
	SELECT m.* FROM swm_int_monthly_trends_nonPLSPC m
	WHERE NOT EXISTS (
		SELECT 1
		FROM swm_int_monthly_trends_nonPLSPC_archive a
